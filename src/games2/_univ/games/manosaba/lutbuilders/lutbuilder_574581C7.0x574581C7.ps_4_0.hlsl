// ---- Created with 3Dmigoto v1.4.1 on Fri Jul 18 09:32:06 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = cb0[135].x * v1.x;
  r0.x = floor(r0.x);
  r1.x = v1.x * cb0[135].x + -r0.x;
  r0.x = cb0[135].z * r0.x;
  r0.z = cb0[135].w * r0.x;
  r1.y = v1.y;
  r0.xy = -cb0[135].zz + r1.xy;
  r1.x = cb0[135].w;
  r1.z = 2;
  ...
  r0.xyz = r0.xyz * cb0[141].zzz + float3(0.0275523961,0.0275523961,0.0275523961);
  ...
  r0.w = saturate(cb0[149].w + r0.w);
  r1.w = 1 + -r0.w;
  r3.xyz = float3(-0.5,-0.5,-0.5) + cb0[149].xyz;
  ...
  r2.xyz = r0.xyz * r0.xyz;
  r0.xyz = sqrt(r0.xyz);
  r3.xyz = float3(-0.5,-0.5,-0.5) + cb0[150].xyz;
  ...
  r0.xyz = exp2(r0.xyz);
  r1.x = dot(r0.xyz, cb0[138].xyz);
  r1.y = dot(r0.xyz, cb0[139].xyz);
  r1.z = dot(r0.xyz, cb0[140].xyz);
  r0.xyz = cb0[146].xyz * r1.xyz;
  r0.w = dot(r1.xyz, float3(0.212672904,0.715152204,0.0721750036));
  r2.xy = -cb0[148].xz + r0.ww;
  r2.zw = cb0[148].yw + -cb0[148].xz;
  ...
  r2.z = cb0[141].x + r3.x;
  r2.yw = float2(0,0);
  r4.xyzw = t4.SampleBias(s0_s, r2.zw, cb0[4].x).xyzw;
  r5.xyzw = t7.SampleBias(s0_s, r2.xy, cb0[4].x).xyzw;
  r5.x = saturate(r5.x);
  r0.y = r5.x + r5.x;
  r4.x = saturate(r4.x);
  r0.z = -0.5 + r4.x;
  ...
  r3.yw = float2(0,0);
  r2.xyzw = t5.SampleBias(s0_s, r3.xy, cb0[4].x).xyzw;
  r3.xyzw = t6.SampleBias(s0_s, r3.zw, cb0[4].x).xyzw;
  r3.x = saturate(r3.x);
  r0.x = r3.x + r3.x;
  r2.x = saturate(r2.x);
  r0.w = r2.x + r2.x;
  ...
  if (RENODX_TONE_MAP_TYPE > 0.f) {
    o0 = UnityYRGBCurvesLutBuilder(r0.xyz, s0_s, t0, t1, t2, t3, cb0[4]);
    return;
  }
  ...
  r0.w = 0;
  r1.xyzw = t0.SampleBias(s0_s, r0.xw, cb0[4].x).xyzw;
  r1.x = saturate(r1.x);
  r2.xyzw = t0.SampleBias(s0_s, r0.yw, cb0[4].x).xyzw;
  r0.xyzw = t0.SampleBias(s0_s, r0.zw, cb0[4].x).xyzw;
  r1.z = saturate(r0.x);
  r1.y = saturate(r2.x);
  r0.xyz = float3(0.00390625,0.00390625,0.00390625) + r1.xyz;
  r0.w = 0;
  r1.xyzw = t1.SampleBias(s0_s, r0.xw, cb0[4].x).xyzw;
  o0.x = saturate(r1.x);
  r1.xyzw = t2.SampleBias(s0_s, r0.yw, cb0[4].x).xyzw;
  r0.xyzw = t3.SampleBias(s0_s, r0.zw, cb0[4].x).xyzw;
  o0.z = saturate(r0.x);
  o0.y = saturate(r1.x);
  o0.w = 1;
