// ---- Created with 3Dmigoto v1.4.1 on Thu Jun 26 22:54:56 2025
  ...
  out float4 o1 : SV_Target1)
{
  ...
  // ---- ALBEDO/DIFFUSE TEXTURE SAMPLE ----
  r0.y = cmp(0.5 < cb2[24].w);
  if (r0.y != 0) {
    r6.xyzw = t1.Sample(s1_s, w0.xy).xyzw;
  } else {
    r6.xyzw = t1.Sample(s1_s, w0.xy).xyzw;
  }
  ...
  r9.x = sqrt(r9.x);
  r9.x = r9.x * r9.x + r9.x;
  r9.yzw = -cb0[15].xyz + v1.xyz;
  r9.y = dot(r9.yzw, r9.yzw);
  r9.x = cmp(r9.x >= r9.y);

  // ---- SHADOW/REFLECTION/ENVIRONMENT MAP LOGIC ----
  if (r9.x != 0) {
    r9.xyz = -cb4[20].xyz + v1.xyz;
    r10.xyz = -cb4[21].xyz + v1.xyz;
    r11.xyz = -cb4[22].xyz + v1.xyz;
    r12.xyz = -cb4[23].xyz + v1.xyz;
    ...
    r9.x = (uint)r9.x;
    r9.x = (uint)r9.x << 2;
    r9.yzw = cb4[r9.x+1].xyz * v1.yyy;
    r9.yzw = cb4[r9.x+0].xyz * v1.xxx + r9.yzw;
    r9.yzw = cb4[r9.x+2].xyz * v1.zzz + r9.yzw;
    ...
    r9.x = r11.y * r9.w;
    r9.y = cb2[0].w + r9.z;
    r9.w = t6.SampleCmpLevelZero(s6_s, r14.xy, r9.y).x;
    r10.x = t6.SampleCmpLevelZero(s6_s, r14.zw, r9.y).x;
    r10.x = r16.y * r10.x;
    r9.w = r16.x * r9.w + r10.x;
    r10.x = t6.SampleCmpLevelZero(s6_s, r10.zw, r9.y).x;
    r9.w = r16.z * r10.x + r9.w;
    r10.x = t6.SampleCmpLevelZero(s6_s, r13.xy, r9.y).x;
    r9.w = r16.w * r10.x + r9.w;
    r10.x = t6.SampleCmpLevelZero(s6_s, r15.xy, r9.y).x;
    r9.w = r17.x * r10.x + r9.w;
    r10.x = t6.SampleCmpLevelZero(s6_s, r15.zw, r9.y).x;
    r9.w = r17.y * r10.x + r9.w;
    r10.x = t6.SampleCmpLevelZero(s6_s, r13.zw, r9.y).x;
    r9.w = r17.z * r10.x + r9.w;
    r10.x = t6.SampleCmpLevelZero(s6_s, r12.xy, r9.y).x;
    r9.w = r17.w * r10.x + r9.w;
    r9.y = t6.SampleCmpLevelZero(s6_s, r12.zw, r9.y).x;
    r9.x = r9.x * r9.y + r9.w;
    r9.y = 1 + -cb4[32].x;
  ...
  // ---- REFLECTION/ENVIRONMENT LIGHTING ----
  ...
  // ---- SPECULAR/BRDF/FINAL COLOR CALCULATION ----
  r0.y = cb1[26].z * r9.x;
  ...
  // ---- SPECIAL CASE: VOLUMETRIC/VOXEL/GRID LIGHTING ----
  if (cb0[174].z != 0) {
    r3.xyz = float3(0.03125,0.03125,0.03125) * cb0[173].xyz;
    r7.yzw = -cb0[172].xyz + v1.xyz;
