...
// ---- Created with 3Dmigoto v1.4.1 on Thu Jun 26 05:39:26 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.xy = cmp(cb0[53].xx == float2(0,1));
  r5.xyz = r1.xyz * r2.xyz + r0.xyz;
  r4.xzw = r4.xxx ? r5.xyz : r0.xyz;
  r1.xyz = r1.xyz * r2.xyz + r4.xzw;
  r2.xyz = saturate(r4.xzw);
  r2.xyz = min(r4.xzw, r2.xyz);
  r1.xyz = -r3.xyz * r2.xyz + r1.xyz;
  r0.xyz = r4.yyy ? r1.xyz : r4.xzw;
