// ---- Created with 3Dmigoto v1.4.1 on Sat Jul 12 18:54:14 2025
...
// ===== Original Shader Code (from dump/0xF52A2A61.ps_4_0.hlsl) =====
/*
// ---- Created with 3Dmigoto v1.4.1 on Sun Jul 20 13:32:30 2025
Texture2D<float4> t5 : register(t5);
