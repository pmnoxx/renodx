...
// ---- Created with 3Dmigoto v1.4.1 on Sun Jul 20 04:19:11 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r0.w != 0) {
    ...
    r4.xyzw = t4.Sample(s4_s, v1.xy).xyzw;
    r1.xyz = float3(1,1,1) + -cb0[37].xyz;
    r1.xyz = r4.www * r1.xyz + cb0[37].xyz;
  ...
  r4.xyzw = t3.Sample(s3_s, r1.xz).xyzw;
  r2.z = cb0[36].y;
  r0.zw = r1.xz + r2.zw;
