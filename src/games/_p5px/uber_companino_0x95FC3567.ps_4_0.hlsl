...
// ---- Created with 3Dmigoto v1.4.1 on Thu Jun 26 23:51:04 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xy = cb0[28].yy * r0.xy;
  r0.xyzw = t2.Sample(s2_s, r0.xy).xyzw;
  r1.xyzw = cb0[36].yyyy * r0.xyzw;
  r1.xyzw = max(r2.xyzw, r1.xyzw);
  r0.xyzw = r0.xyzw * cb0[36].yyyy + r2.xyzw;
  r0.xyzw = r0.xyzw + -r1.xyzw;
  r0.xyzw = cb0[36].wwww * r0.xyzw + r1.xyzw;
