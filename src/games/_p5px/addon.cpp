...
renodx::mods::shader::CustomShaders custom_shaders = {
   ...
   CustomShaderEntry(0x8B00D455), // uber_classroom
   CustomShaderEntry(0x5032F099), // uber_velvet_room
   CustomShaderEntry(0x7C7A90FB), // uber_roof
   CustomShaderEntry(0x7910DC27), // uber_cutscene2
   CustomShaderEntry(0xB05DD1FC), // uber_cutscene3
   CustomShaderEntry(0x085B95F5), // uber_
   CustomShaderEntry(0x95FC3567),
   CustomShaderEntry(0xB94F0EC5),
   CustomShaderEntry(0x93CAF565), // lut builder
   CustomShaderEntry(0x4E674C6E), // Lut builder (velvet room)
   CustomShaderEntry(0x12E5EFDD), // Lut builder (velvet room)
};
