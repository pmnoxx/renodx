...
// ---- Created with 3Dmigoto v1.4.1 on Thu Jun 26 16:13:05 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  // ========================================
  // SECTION 1: UV COORDINATE CALCULATION
  // ========================================
  ...
  // ========================================
  // SECTION 2: TONE MAPPING PREPROCESSING
  // ========================================
  // Apply PQ decoding and LogC conversion for HDR content
  if (RENODX_TONE_MAP_TYPE > 0.f) {
    // Decode PQ (Perceptual Quantizer) to linear space
    r0.xzw = renodx::color::pq::Decode(r0.xzw, 100.f);

    // Convert linear to LogC color space (ARRI LogC)
    // This is the inverse of the standard LogC to linear conversion
  ...
  // ========================================
  // SECTION 3: COLOR SPACE TRANSFORMATIONS
  // ========================================
  // Apply color space matrix transformations
  // Convert from working color space to target color space
  ...
  // ========================================
  // SECTION 4: RGB TO YUV CONVERSION
  // ========================================
  // Convert RGB to YUV color space using standard coefficients
  r1.x = dot(float3(0.390404999,0.549941003,0.00892631989), r0.xyz);  // Y component
  r1.y = dot(float3(0.070841603,0.963172019,0.00135775004), r0.xyz);  // U component  
  r1.z = dot(float3(0.0231081992,0.128021002,0.936245024), r0.xyz);   // V component
  r0.xyz = cb0[32].xyz * r1.xyz;

  // ========================================
  // SECTION 5: YUV TO RGB CONVERSION
  // ========================================
  // Convert back from YUV to RGB using inverse matrix
  ...
  // ========================================
  // SECTION 6: COLOR MATRIX TRANSFORMATIONS
  // ========================================
  // Apply additional color matrix transformations
  ...
  // ========================================
  // SECTION 7: LOGARITHMIC PROCESSING
  // ========================================
  // Apply logarithmic processing for dynamic range compression
  ...
  // ========================================
  // SECTION 8: HSV COLOR SPACE CONVERSION
  // ========================================
  ...
  r2.z = r1.w;
  r1.w = r0.x;
  r3.x = dot(r0.xyz, float3(0.212672904,0.715152204,0.0721750036));  // Calculate luminance
  r2.xyw = r1.wyx;
  ...
  // ========================================
  // SECTION 9: LUT SAMPLING AND INTERPOLATION
  // ========================================
  // Sample from the LUT texture for color correction
  ...
  // ========================================
  // SECTION 10: ADDITIONAL LUT PROCESSING
  // ========================================
  // Apply additional LUT-based color adjustments
  ...
  // ========================================
  // SECTION 11: FINAL OUTPUT PROCESSING
  // ========================================
  // Apply final tone mapping based on configuration
  if (RENODX_TONE_MAP_TYPE == 0.f) {
    // Standard LUT-based color grading path
    // Add small offset and sample from LUT texture
    ...
    // HDR tone mapping path - output processed color directly
    o0.xyz = r0.xyz;
  }
