...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .labels = {"Vanilla", "None", "ACES", "RenoDRT (>HDR1000)", "Dice (<HDR800)", "Frostbite"},
    ...
    new renodx::utils::settings::Setting{
        ...
        .max = 5.f,
        .format = "%.2f",
        .is_visible = []() { return current_settings_mode >= 1 && shader_injection.tone_map_type == 4.f; },
    },
    new renodx::utils::settings::Setting{
        .key = "EffectSplitMode",
...
const std::unordered_map<std::string, std::pair<reshade::api::format, float>> UPGRADE_TARGETS = {
    ...
    //{"R8_TYPELESS", {reshade::api::format::r8_typeless, 1.f}},
};
...
/*
        ...
        //      .ignore_size = (value == UPGRADE_TYPE_ANY),
            ...
            .new_dimensions = {.width= 1024 * 2, .height= 32*2,},
...
//      .ignore_size = (value == UPGRADE_TYPE_ANY),
      ...
      .new_dimensions = {.width= 3840, .height= 2160,},
      .usage_include = reshade::api::resource_usage::render_target,
   //   .usage_include = reshade::api::resource_usage::render_target,
  });
  renodx::mods::swapchain::swap_chain_upgrade_targets.push_back({
