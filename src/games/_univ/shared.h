...
#define RENODX_GAME_NITS                     shader_injection.graphics_white_nits
#define RENODX_UI_NITS                       shader_injection.diffuse_white_nits
...
#define RENODX_CUSTOM_CHARACTER_BRIGHTNESS      shader_injection.custom_character_brightness
