...
// unknown dcl_: dcl_thread_group 4, 4, 4
  ...
  if (RENODX_TONE_MAP_TYPE > 0.f) {
    r0.xyz = renodx::color::bt709::clamp::BT2020(r1.xyz);
  } else {
    r0.xyz = float3(1.31338608,1.31338608,1.31338608) * r1.xyz;
    r2.xyz = r1.xyz * float3(0.262677222,0.262677222,0.262677222) + float3(0.0695999935,0.0695999935,0.0695999935);
    r2.xyz = r0.xyz * r2.xyz + float3(0.00543999998,0.00543999998,0.00543999998);
    r1.xyz = r1.xyz * float3(0.262677222,0.262677222,0.262677222) + float3(0.289999992,0.289999992,0.289999992);
    r0.xyz = r0.xyz * r1.xyz + float3(0.0816000104,0.0816000104,0.0816000104);
