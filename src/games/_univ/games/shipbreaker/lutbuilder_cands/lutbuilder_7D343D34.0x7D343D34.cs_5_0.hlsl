...
// ---- Created with 3Dmigoto v1.4.1 on Fri Jul 25 02:30:49 2025
...
// unknown dcl_: dcl_thread_group 4, 4, 4
  ...
  r0.xyz = cb0[18].xxx * r1.xyz;
  r2.xyzw = cmp(r0.xxyy < cb0[18].yzyz);
  ...
  r0.x = r0.y ? r0.x : 0;
  r3.y = r0.x * r2.w + r2.y;
  r0.xy = cmp(r0.zz < cb0[18].yz);
  r2.xyzw = r0.yyyy ? cb0[21].xyzw : cb0[23].xyzw;
  r0.yz = r0.yy ? cb0[22].xy : cb0[24].xy;
  r2.xyzw = r0.xxxx ? cb0[19].xyzw : r2.xyzw;
  r0.xy = r0.xx ? cb0[20].xy : r0.yz;
  r0.z = r1.z * cb0[18].x + -r2.x;
  r0.z = r0.z * r2.z;
  r0.w = cmp(0 < r0.z);
  r0.z = log2(r0.z);
  r0.y = r0.y * r0.z;
