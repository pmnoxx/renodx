...
// ---- Created with 3Dmigoto v1.4.1 on Thu Jul 24 03:33:26 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  // Use Unity YRGB Curves LUT Builder function
  if (RENODX_TONE_MAP_TYPE > 0.f) {
    o0 = UnityYRGBCurvesLutBuilder(r0.xyz, s0_s, t0, t1, t2, t3, cb0[5]);
    return;
  }
