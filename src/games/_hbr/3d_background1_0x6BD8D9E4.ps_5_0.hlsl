  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r3.x != 0) {
    ...
    if (r3.x != 0) {
      ...
      r4.x = t4.SampleCmpLevelZero(s0_s, r3.xy, r0.z).x;
      r4.y = t4.SampleCmpLevelZero(s0_s, r3.zw, r0.z).x;
      r3.xyzw = cb2[26].xyzw + r0.xyxy;
      r4.z = t4.SampleCmpLevelZero(s0_s, r3.xy, r0.z).x;
      r4.w = t4.SampleCmpLevelZero(s0_s, r3.zw, r0.z).x;
      ...
      if (r3.y != 0) {
        ...
        r3.y = r5.y * r4.z;
        r3.z = t4.SampleCmpLevelZero(s0_s, r8.xy, r0.z).x;
        r3.w = t4.SampleCmpLevelZero(s0_s, r8.zw, r0.z).x;
        r3.w = r11.y * r3.w;
        r3.z = r11.x * r3.z + r3.w;
        r3.w = t4.SampleCmpLevelZero(s0_s, r9.xy, r0.z).x;
        r3.z = r11.z * r3.w + r3.z;
        r3.w = t4.SampleCmpLevelZero(s0_s, r7.xy, r0.z).x;
        r3.z = r11.w * r3.w + r3.z;
        r3.w = t4.SampleCmpLevelZero(s0_s, r10.xy, r0.z).x;
        r3.z = r12.x * r3.w + r3.z;
        r3.w = t4.SampleCmpLevelZero(s0_s, r10.zw, r0.z).x;
        r3.z = r12.y * r3.w + r3.z;
        r3.w = t4.SampleCmpLevelZero(s0_s, r7.zw, r0.z).x;
        r3.z = r12.z * r3.w + r3.z;
        r3.w = t4.SampleCmpLevelZero(s0_s, r6.xy, r0.z).x;
        r3.z = r12.w * r3.w + r3.z;
        r3.w = t4.SampleCmpLevelZero(s0_s, r6.zw, r0.z).x;
        r3.x = r3.y * r3.w + r3.z;
      } else {
        r3.yz = r0.xy * cb2[28].zw + float2(0.5,0.5);
        r3.yz = floor(r3.yz);
        ...
        r3.w = t4.SampleCmpLevelZero(s0_s, r9.xy, r0.z).x;
        r5.x = t4.SampleCmpLevelZero(s0_s, r9.zw, r0.z).x;
        r5.x = r15.y * r5.x;
        r3.w = r15.x * r3.w + r5.x;
        r5.x = t4.SampleCmpLevelZero(s0_s, r10.xy, r0.z).x;
        r3.w = r15.z * r5.x + r3.w;
        r5.x = t4.SampleCmpLevelZero(s0_s, r12.xy, r0.z).x;
        r3.w = r15.w * r5.x + r3.w;
        r5.x = t4.SampleCmpLevelZero(s0_s, r11.xy, r0.z).x;
        r3.w = r16.x * r5.x + r3.w;
        r5.x = t4.SampleCmpLevelZero(s0_s, r11.zw, r0.z).x;
        r3.w = r16.y * r5.x + r3.w;
        r5.x = t4.SampleCmpLevelZero(s0_s, r10.zw, r0.z).x;
        r3.w = r16.z * r5.x + r3.w;
        r5.x = t4.SampleCmpLevelZero(s0_s, r12.zw, r0.z).x;
        r3.w = r16.w * r5.x + r3.w;
        r5.x = t4.SampleCmpLevelZero(s0_s, r13.xy, r0.z).x;
        r3.w = r17.x * r5.x + r3.w;
        r5.x = t4.SampleCmpLevelZero(s0_s, r13.zw, r0.z).x;
        r3.w = r17.y * r5.x + r3.w;
        r5.x = t4.SampleCmpLevelZero(s0_s, r5.yz, r0.z).x;
        r3.w = r17.z * r5.x + r3.w;
        r5.x = t4.SampleCmpLevelZero(s0_s, r14.xy, r0.z).x;
        r3.w = r17.w * r5.x + r3.w;
        r5.x = t4.SampleCmpLevelZero(s0_s, r8.xy, r0.z).x;
        r3.w = r4.x * r5.x + r3.w;
        r4.x = t4.SampleCmpLevelZero(s0_s, r8.zw, r0.z).x;
        r3.w = r4.y * r4.x + r3.w;
        r4.x = t4.SampleCmpLevelZero(s0_s, r7.zw, r0.z).x;
        r3.w = r4.z * r4.x + r3.w;
        r3.y = t4.SampleCmpLevelZero(s0_s, r3.yz, r0.z).x;
        r3.x = r4.w * r3.y + r3.w;
      }
    }
  } else {
    r3.x = t4.SampleCmpLevelZero(s0_s, r0.xy, r0.z).x;
  }
  r0.x = 1 + -cb2[27].x;
  ...
  r4.xyzw = t1.Sample(s1_s, v7.zw).xyzw;
  r4.xyzw = cb0[163].xyzw * r4.xyzw;
  r4.xyz = r4.xyz * r4.www;
  r4.xyz = cb0[161].yyy * r4.xyz;
  r5.xyzw = t2.Sample(s2_s, v7.xy).xyzw;
  r0.w = cb0[165].w * r5.w;
