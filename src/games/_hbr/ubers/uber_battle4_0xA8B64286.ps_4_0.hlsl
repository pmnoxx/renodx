...
*/
  ...
  if (RENODX_TONE_MAP_TYPE != 0) {
    float4 toneMapResult = ToneMapBlock(r0.xyz, r0.w, cb0[42].x, t5, SCENE_TYPE_3D);
    o0 = toneMapResult;
    // o0 = debug_mode(o0, v1);
    return;
  }
...
// ===== Original Shader Code (from dump/uber_battle4_0xA8B64286.ps_4_0.hlsl) =====
/*
// ---- Created with 3Dmigoto v1.4.1 on Sun Jul 20 13:32:33 2025
Texture2D<float4> t5 : register(t5);
