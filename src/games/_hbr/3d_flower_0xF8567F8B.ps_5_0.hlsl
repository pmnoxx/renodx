// ---- Created with 3Dmigoto v1.4.1 on Tue Jul  1 16:51:04 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.xyz = t4.SampleBias(s0_s, r2.xy, cb0[5].x).xyz;
  r2.xyzw = t5.SampleBias(s1_s, r2.xy, cb0[5].x).xyzw;
  ...
  if (r4.x != 0) {
    ...
    if (r4.x != 0) {
      ...
      r5.x = t6.SampleCmpLevelZero(s2_s, r4.xy, r0.z).x;
      r5.y = t6.SampleCmpLevelZero(s2_s, r4.zw, r0.z).x;
      r4.xyzw = cb2[26].xyzw + r0.xyxy;
      r5.z = t6.SampleCmpLevelZero(s2_s, r4.xy, r0.z).x;
      r5.w = t6.SampleCmpLevelZero(s2_s, r4.zw, r0.z).x;
      ...
      if (r4.y != 0) {
        ...
        r4.y = r6.y * r5.z;
        r4.z = t6.SampleCmpLevelZero(s2_s, r9.xy, r0.z).x;
        r4.w = t6.SampleCmpLevelZero(s2_s, r9.zw, r0.z).x;
        r4.w = r12.y * r4.w;
        r4.z = r12.x * r4.z + r4.w;
        r4.w = t6.SampleCmpLevelZero(s2_s, r10.xy, r0.z).x;
        r4.z = r12.z * r4.w + r4.z;
        r4.w = t6.SampleCmpLevelZero(s2_s, r8.xy, r0.z).x;
        r4.z = r12.w * r4.w + r4.z;
        r4.w = t6.SampleCmpLevelZero(s2_s, r11.xy, r0.z).x;
        r4.z = r13.x * r4.w + r4.z;
        r4.w = t6.SampleCmpLevelZero(s2_s, r11.zw, r0.z).x;
        r4.z = r13.y * r4.w + r4.z;
        r4.w = t6.SampleCmpLevelZero(s2_s, r8.zw, r0.z).x;
        r4.z = r13.z * r4.w + r4.z;
        r4.w = t6.SampleCmpLevelZero(s2_s, r7.xy, r0.z).x;
        r4.z = r13.w * r4.w + r4.z;
        r4.w = t6.SampleCmpLevelZero(s2_s, r7.zw, r0.z).x;
        r4.x = r4.y * r4.w + r4.z;
      } else {
        r4.yz = r0.xy * cb2[28].zw + float2(0.5,0.5);
        r4.yz = floor(r4.yz);
        ...
        r4.w = t6.SampleCmpLevelZero(s2_s, r10.xy, r0.z).x;
        r6.x = t6.SampleCmpLevelZero(s2_s, r10.zw, r0.z).x;
        r6.x = r16.y * r6.x;
        r4.w = r16.x * r4.w + r6.x;
        r6.x = t6.SampleCmpLevelZero(s2_s, r11.xy, r0.z).x;
        r4.w = r16.z * r6.x + r4.w;
        r6.x = t6.SampleCmpLevelZero(s2_s, r13.xy, r0.z).x;
        r4.w = r16.w * r6.x + r4.w;
        r6.x = t6.SampleCmpLevelZero(s2_s, r12.xy, r0.z).x;
        r4.w = r17.x * r6.x + r4.w;
        r6.x = t6.SampleCmpLevelZero(s2_s, r12.zw, r0.z).x;
        r4.w = r17.y * r6.x + r4.w;
        r6.x = t6.SampleCmpLevelZero(s2_s, r11.zw, r0.z).x;
        r4.w = r17.z * r6.x + r4.w;
        r6.x = t6.SampleCmpLevelZero(s2_s, r13.zw, r0.z).x;
        r4.w = r17.w * r6.x + r4.w;
        r6.x = t6.SampleCmpLevelZero(s2_s, r14.xy, r0.z).x;
        r4.w = r18.x * r6.x + r4.w;
        r6.x = t6.SampleCmpLevelZero(s2_s, r14.zw, r0.z).x;
        r4.w = r18.y * r6.x + r4.w;
        r6.x = t6.SampleCmpLevelZero(s2_s, r6.yz, r0.z).x;
        r4.w = r18.z * r6.x + r4.w;
        r6.x = t6.SampleCmpLevelZero(s2_s, r15.xy, r0.z).x;
        r4.w = r18.w * r6.x + r4.w;
        r6.x = t6.SampleCmpLevelZero(s2_s, r9.xy, r0.z).x;
        r4.w = r5.x * r6.x + r4.w;
        r5.x = t6.SampleCmpLevelZero(s2_s, r9.zw, r0.z).x;
        r4.w = r5.y * r5.x + r4.w;
        r5.x = t6.SampleCmpLevelZero(s2_s, r8.zw, r0.z).x;
        r4.w = r5.z * r5.x + r4.w;
        r4.y = t6.SampleCmpLevelZero(s2_s, r4.yz, r0.z).x;
        r4.x = r5.w * r4.y + r4.w;
      }
    }
  } else {
    r4.x = t6.SampleCmpLevelZero(s2_s, r0.xy, r0.z).x;
  }
  r0.x = 1 + -cb2[27].x;
  ...
  r4.xyzw = t1.Sample(s3_s, v7.zw).xyzw;
  r4.xyzw = cb0[163].xyzw * r4.xyzw;
  r4.xyz = r4.xyz * r4.www;
  r4.xyz = cb0[161].yyy * r4.xyz;
  r5.xyzw = t2.Sample(s4_s, v7.xy).xyzw;
  r0.w = cb0[165].w * r5.w;
  r0.xyz = r2.xyz * r0.xyz + r4.xyz;
  r0.xyz = -r3.xyz * r4.xyz + r0.xyz;
  r0.w = cb0[161].y * r0.w;
  r2.xyz = cb0[165].xyz * r5.xyz + -r0.xyz;
  r0.xyz = r0.www * r2.xyz + r0.xyz;
  r2.xyzw = t3.Sample(s5_s, v6.zw).xyzw;
