...
// ---- Created with 3Dmigoto v1.4.1 on Tue Jul  1 16:41:27 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xy = v3.xy * cb2[1].xy + cb2[1].zw;
  r1.xyzw = t0.Sample(s4_s, r1.xy).xyzw;

 // r1.xyz = ApplyReverseReinhard(r1.xyz);

  r2.xyz = cb2[6].xyz * r1.xyz;
  r0.xyz = r2.xyz * r0.xyz;
  r2.xyz = -cb2[11].xyz + cb0[168].xyz;
  r2.xyz = cb0[168].www * r2.xyz + cb2[11].xyz;
  r0.xyz = r2.xyz * r0.xyz;
  r0.xyz = cb2[9].xxx * r0.xyz;
  r0.xyz = r0.xyz * cb0[151].xyz + cb0[157].xyz;
  r0.w = 1 + -r1.w;
  r1.xyz = r1.xyz * r0.www;
  r0.xyz = r1.xyz * cb2[5].xyz + r0.xyz;
  ...
  r1.xyz = cb2[0].xyz * r1.xyz;
  r1.xyz = v7.xxx * r1.xyz;
  r2.xyz = -cb2[10].xyz + cb0[170].xyz;
  r2.xyz = cb0[170].www * r2.xyz + cb2[10].xyz;
  r1.xyz = r2.xyz * r1.xyz;
  r1.xyz = cb2[9].yyy * r1.xyz;
  ...
  r0.w = cb2[6].w * cb0[149].w;
  r0.xyzw = cb0[155].xyzw + r0.xyzw;
  o0.xyzw = r0.xyzw * cb2[4].xyzw + cb2[3].xyzw;
  return;
}