// ---- Created with 3Dmigoto v1.4.1 on Tue Jul  1 16:50:04 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xy = v3.xy * cb3[1].xy + cb3[1].zw;
  r2.xyzw = t1.Sample(s7_s, r2.xy).xyzw;
  ...
  r4.xyzw = t2.Sample(s3_s, v7.zw).xyzw;
  r4.xyzw = cb0[163].xyzw * r4.xyzw;
  r4.xyz = r4.xyz * r4.www;
  r4.xyz = cb0[161].yyy * r4.xyz;
  r5.xyzw = t3.Sample(s4_s, v7.xy).xyzw;
  r0.w = cb0[165].w * r5.w;
