...
// ---- Created with 3Dmigoto v1.4.1 on Tue Jul  1 15:03:31 2025
// Decompiled Unity Uber Shader fragment (pixel) shader
// Comments and section headers added for clarity and Unity HLSL reference
  ...
  out float4 o0 : SV_Target0)
{
  ...
  float3 untonemapped = r2.xyz; // Save for tonemapping later

  
  r0.xyz = renodx::color::pq::EncodeSafe(r2.xyz, 100.f);
