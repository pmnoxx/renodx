...
// ---- Created with 3Dmigoto v1.4.1 on Tue Jul  8 17:43:39 2025
...
/*
  ...
  r3.xyz = max(float3(1.1920929e-07,1.1920929e-07,1.1920929e-07), abs(r1.yzw));
  r3.xyz = log2(r3.xyz);
...
// ===== Original Shader Code (from dump/0xE5E4F46C.ps_4_0.hlsl) =====
/*
// ---- Created with 3Dmigoto v1.4.1 on Sun Jul 20 13:50:12 2025
Texture2D<float4> t4 : register(t4);
