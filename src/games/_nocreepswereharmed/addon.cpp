...
renodx::mods::shader::CustomShaders custom_shaders = {
   CustomShaderEntry(0xAFBE175C), // uber_ult2_0x0DE9EBCF.ps_4_0.hlsl
};
...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        .key = "UserToneMapType",
        .binding = &shader_injection.userToneMapType,
        .value_type = renodx::utils::settings::SettingValueType::INTEGER,
        .default_value = 5.f,
        .can_reset = true,
        .label = "User Tone Map Type",
        .section = "Game Specific Settings",
        .tooltip = "User override for tone mapping type (advanced)",
        .labels = {"Vanilla", "None", "DICE", "Reinhard", "Frostbite", "GlobalTonemapper"},
        .is_visible = []() { return current_settings_mode >= 2; },
    },
...
BOOL APIENTRY DllMain(HMODULE h_module, DWORD fdw_reason, LPVOID lpv_reserved) {
  ...
  // Before using shader_injection, sync userToneMapType
