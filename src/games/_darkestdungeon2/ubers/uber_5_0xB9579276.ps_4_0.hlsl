...
// ---- Created with 3Dmigoto v1.4.1 on Wed Jul 23 18:28:41 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (RENODX_TONE_MAP_TYPE != 0.f) {
    r0.xyz = UnityLookupARIDPQ(r0.xyzw, v1.xy, cb0[132], s0_s, t3);
    r0.xyz = UnityLookupSDRsRGB(r0.xyz, v1.xy, cb0[133].w, t4);
