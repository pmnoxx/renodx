...
/*
   if (RENODX_TONE_MAP_TYPE != 0.f) {
    o0 = renodx_opening_tonemap_block(untonemapped, saturate(r1), v1, t2, t3, cmp(0 < cb0[133].w), true);
    return;
  }
*/
  ...
  if (RENODX_TONE_MAP_TYPE != 0.f) {
    o0 = renodx_opening_tonemap_block(untonemapped, saturate(r1), v1, t2, t3, cmp(0 < 0), true);
    return;
  }
