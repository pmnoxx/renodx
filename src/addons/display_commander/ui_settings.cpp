...
renodx::utils::settings::Settings settings = {
    ...
    // TEMPORARILY DISABLED: DXGI Device Information Tab to debug silent crash
    ...
    //             ImGui::Separator();
    //             ImGui::TextColored(ImVec4(0.8f, 0.8f, 0.8f, 0.8f, 0.8f, 1.0f), "Outputs (%zu):", adapter.outputs.size());
